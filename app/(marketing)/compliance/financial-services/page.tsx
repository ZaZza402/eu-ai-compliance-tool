...
const obligations = [
  { art: "Art. 9", text: "Risk management system addressing model risk, fairness and over-reliance" },
  { art: "Art. 10", text: "Training data governance: representative, no historical bias encoding" },
  { art: "Art. 11", text: "Technical documentation — maintained and available to supervisors" },
  { art: "Art. 12", text: "Automatic logging sufficient for supervisory authority audit trail" },
  { art: "Art. 13", text: "Transparency: customers must understand when AI is used in decisions affecting them" },
  { art: "Art. 14", text: "Human oversight — AI must not autonomously approve or deny credit without oversight" },
  { art: "Art. 22", text: "Where natural persons are involved, right to explanation for AI-assisted decisions" },
  { art: "Art. 43", text: "Conformity assessment before placing the AI system on the market" },
];
      ...
      <div className="container mx-auto max-w-3xl px-4">
        ...
        <div className="mb-10">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            AI systems used in creditworthiness assessment, insurance risk pricing,
            and financial decision-making affecting natural persons are{" "}
        ...
        <div className="mb-10 rounded-xl border border-orange-300 bg-orange-50 p-6 dark:border-orange-700/40 dark:bg-orange-900/20">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="font-semibold text-orange-900 dark:text-orange-200">High-risk financial AI systems</h2>
        ...
        <div className="mb-10">
          <h2 className="mb-4 text-xl font-bold">Obligations for financial AI providers and deployers</h2>
        ...
        <div className="mb-10 rounded-lg border border-border bg-card p-5">
          ...
          <p className="text-sm text-muted-foreground">
            Financial entities are already subject to DORA (Digital Operational Resilience Act)
            and GDPR Article 22 on automated decision-making. The EU AI Act adds a third
            compliance layer: the AI system itself must pass high-risk conformity requirements
            regardless of existing DORA or GDPR controls. These frameworks are complementary,
            not substitutable.
          </p>
        </div>

        <div className="rounded-xl border border-primary/20 bg-primary/5 p-6">
          <h2 className="mb-2 text-lg font-bold">Check your financial AI system</h2>
          <p className="mb-4 text-sm text-muted-foreground">
            Get a precise analysis of your specific tool — credit scoring, fraud detection,
            or insurance pricing. Know your exact obligations before the August 2026 deadline.
          </p>
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/articles/9" className="inline-flex h-9 items-center rounded-lg border border-border px-4 text-sm hover:bg-accent">
              Read Article 9
            </Link>
          </div>
        </div>
